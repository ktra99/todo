  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-7xl space-y-8 px-4 py-12 text-xl">
        <Link
          href="/"
          className="inline-flex items-center rounded-md border border-transparent bg-black px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-900 focus:ring-offset-2"
        >
          <ArrowLongLeftIcon
        ...
        <p className="font-medium">Last updated: February 04, 2023</p>
        <p>
        ...
        <ul className="space-y-8">
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to todo.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to todo, accessible from{" "}
              <a
                href="https://todo.ktra99.dev/"
                rel="noreferrer"
                target="_blank"
                className="font-medium underline"
              >
                https://todo.ktra99.dev/
              </a>
            </p>
          </li>
          <li>
        ...
        <h2 className="text-3xl font-semibold">Types of Data Collected</h2>
        ...
        <ul className="space-y-8">
          <li>By email: kennytran.dev@outlook.com</li>
        </ul>
      </div>
    </>
  );
